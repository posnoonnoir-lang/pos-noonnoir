...
| **ORM** | Prisma v7 (schema ready) | 📋 Planned |
...
| **Toast** | Sonner | ✅ |
| **Data** | Server Actions (mock, Prisma planned) | ✅ |
...
pos-noonnoir/
├── prisma/
│   └── schema.prisma          # 29 tables, full schema (ready for migrate)
├── src/
...
│   │   │   └── pos/
│   │   │       ├── page.tsx           # POS Terminal + Bell + QR Modal
│   │   │       ├── kitchen/           # Kitchen Display
│   │   │       └── orders/            # Order History + Receipt
│   │   └── login/             # PIN Login
│   ├── components/
│   │   ├── layout/            # Sidebar (16 nav items)
...
|--------|----------------|:--------:|
| **Prisma/Supabase** | Connect mock → real PostgreSQL database | P1 |
