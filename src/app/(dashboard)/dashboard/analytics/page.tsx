...
export default function AnalyticsPage() {
    ...
    const [hourly, setHourly] = useState<HourlyHeatmap[]>([])
    const [staff, setStaff] = useState<StaffLeaderboard[]>([])
    const [weeklyRev, setWeeklyRev] = useState<DailyRevenue[]>([])
        ...
        return (
            <div className="min-h-screen bg-cream-50 flex items-center justify-center">
                <div className="text-center space-y-3">
                    <RefreshCw className="h-8 w-8 animate-spin text-green-700 mx-auto" />
                    <p className="text-sm text-cream-400">Đang tải Analytics...</p>
                </div>
            </div>
        )
    }
